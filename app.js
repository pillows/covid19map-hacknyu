...
// This is to parse the confirmed infected data as an array to a new file
fs.readFile('./csse_covid_19_time_series/time_series_19-covid-Confirmed.csv', 'utf8', function(err, contents){
    ...
    fs.writeFile('confirmed-reports', arrData, function (err){
        if(err) {throw err};
...
// This is to parse the recovered  data as an array to a new file
fs.readFile('./csse_covid_19_time_series/time_series_19-covid-Recovered.csv', 'utf8', function(err, contents){
    confirmed = contents;
    strDelimiter =  ",";
    ...
    fs.writeFile('recovered-reports', arrData, function (err){
        if(err) {throw err};
        console.log("Completed");
    });
    // var totalConfirmed = document.getElementById('confirmed');
...
// This is to parse the recovered  data as an array to a new file
fs.readFile('./csse_covid_19_time_series/time_series_19-covid-Deaths.csv', 'utf8', function(err, contents){
    confirmed = contents;
    strDelimiter =  ",";
    ...
    fs.writeFile('death-reports', arrData, function (err){
        if(err) {throw err};
        console.log("Completed");
    });
    // var totalConfirmed = document.getElementById('confirmed');
